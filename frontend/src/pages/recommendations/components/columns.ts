...
function getScoreStyle(score: number): string {
  if (score >= 8) return 'border-teal-500 bg-teal-50 text-teal-700 dark:bg-teal-950 dark:text-teal-300'
  if (score >= 5) return 'border-sky-500 bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-300'
  return ''
}
