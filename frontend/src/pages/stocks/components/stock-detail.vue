...
const priceChange = computed(() => {
  if (!props.stock.targetFrom || !props.stock.targetTo) return null
...
<template>
  <div>
    ...
    <div class="grid grid-cols-2 gap-4 py-4">
      <div class="space-y-1">
        <p class="text-sm text-muted-foreground">Rating Change</p>
      ...
      <div class="space-y-1">
        ...
        <p class="text-sm font-medium">{{ stock.brokerage }}</p>
      </div>
